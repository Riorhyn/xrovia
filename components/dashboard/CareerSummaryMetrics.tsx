...
export function CareerSummaryMetrics() {
  ...
  useEffect(() => {
    ...
    return () => {
      window.removeEventListener("profile_updated", loadCounts);
    ...
    <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm space-y-4">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        <div className="rounded-2xl border border-slate-100 bg-slate-50/50 p-4 text-center space-y-1">
          ...
          <p className="text-2xl font-black text-slate-900 font-mono">{counts.experience}</p>
        ...
        <div className="rounded-2xl border border-slate-100 bg-slate-50/50 p-4 text-center space-y-1">
          ...
          <p className="text-2xl font-black text-slate-900 font-mono">{counts.education}</p>
        ...
        <div className="rounded-2xl border border-slate-100 bg-slate-50/50 p-4 text-center space-y-1">
          ...
          <p className="text-2xl font-black text-slate-900 font-mono">{counts.skills}</p>
        ...
        <div className="rounded-2xl border border-slate-100 bg-slate-50/50 p-4 text-center space-y-1">
          ...
          <p className="text-2xl font-black text-slate-900 font-mono">{counts.projects}</p>

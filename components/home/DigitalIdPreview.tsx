...
export function DigitalIdPreview() {
  ...
  return (
    <>
      <div className="mx-auto w-full max-w-sm rounded-3xl border border-slate-200 bg-white p-5 shadow-xl space-y-4 text-slate-900">
        ...
        <div className="flex items-center justify-between gap-3 pt-1">
          <div className="flex items-center gap-3 min-w-0">
            <div className="h-12 w-12 rounded-full bg-blue-100 text-blue-800 font-extrabold text-sm flex items-center justify-center shrink-0 overflow-hidden border border-blue-200">
              {profile.photoUrl ? (
                <img
            ...
            <div className="min-w-0">
              ...
              <p className="text-xs text-slate-500 truncate mt-0.5">{profile.headline}</p>
              <p className="text-[11px] text-slate-400 truncate flex items-center gap-1 mt-0.5">
                <MapPin className="h-3 w-3 text-slate-400 shrink-0" /> {profile.location}
              </p>
            </div>
          </div>
          ...
          <button
            ...
            className="p-1.5 bg-slate-50 hover:bg-blue-50 border border-slate-200 rounded-xl shrink-0 transition"
        ...
        <div className="rounded-2xl bg-blue-50/80 p-3.5 border border-blue-100 flex items-center justify-between">
          <div>
            ...
            <p className="text-xl font-black text-blue-700 font-mono tracking-tight mt-0.5">
        ...
        <div>
          ...
          <p className="text-xs font-medium text-slate-700 mt-0.5 leading-relaxed line-clamp-2">
            {profile.about}
          </p>
        </div>
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-1.5">
            {profile.skills.slice(0, 4).map((skill) => (
              <span
                key={skill}
                className="rounded-lg bg-slate-100 border border-slate-200/80 px-2.5 py-0.5 text-[10px] font-bold text-slate-700"
              >
                {skill}
              </span>
            ))}
        ...
        <div className="grid grid-cols-2 gap-2.5 pt-1">
          <div className="rounded-xl border border-slate-200/80 bg-slate-50/60 p-2.5 flex flex-col justify-between space-y-1 min-h-[58px]">
            <div className="flex items-center justify-between text-slate-600">
              <span className="flex items-center gap-1 text-[11px] font-bold text-slate-800">
                <GraduationCap className="h-3.5 w-3.5 text-blue-600 shrink-0" /> Education
              </span>
              <span className="text-xs font-black text-blue-600">{profile.educationCount}</span>
            </div>
            <p className="text-[10px] text-slate-600 font-semibold line-clamp-2 leading-tight">
          ...
          <div className="rounded-xl border border-slate-200/80 bg-slate-50/60 p-2.5 flex flex-col justify-between space-y-1 min-h-[58px]">
            <div className="flex items-center justify-between text-slate-600">
              <span className="flex items-center gap-1 text-[11px] font-bold text-slate-800">
                <Briefcase className="h-3.5 w-3.5 text-blue-600 shrink-0" /> Experience
              </span>
          ...
          <div className="rounded-xl border border-slate-200/80 bg-slate-50/60 p-2.5 flex flex-col justify-between space-y-1 min-h-[58px]">
            <div className="flex items-center justify-between text-slate-600">
              <span className="flex items-center gap-1 text-[11px] font-bold text-slate-800">
                <Wrench className="h-3.5 w-3.5 text-blue-600 shrink-0" /> Skills
              </span>
          ...
          <div className="rounded-xl border border-slate-200/80 bg-slate-50/60 p-2.5 flex flex-col justify-between space-y-1 min-h-[58px]">
            <div className="flex items-center justify-between text-slate-600">
              <span className="flex items-center gap-1 text-[11px] font-bold text-slate-800">
                <FolderGit2 className="h-3.5 w-3.5 text-blue-600 shrink-0" /> Projects
              </span>

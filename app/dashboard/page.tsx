        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm space-y-4">
              <div className="flex items-center gap-2 text-slate-700 bg-slate-50 w-fit px-3 py-1 rounded-full text-xs font-bold border border-slate-200"><Lock className="h-4 w-4"/> Privacy controls</div>
              <div><h3 className="text-sm font-bold text-slate-900">You control your public profile</h3><p className="text-xs text-slate-500 mt-1 leading-relaxed">Use the Career Command Center above to switch your Professional ID profile between public and private. Uploaded evidence files remain private.</p></div>
            </div>
          </div>
        </div>
        <VerificationCenter />

...
export const metadata: Metadata = {
  title: "Professional Certification Profile",
  description: "Professional Certification Profile | XROVIA",
  keywords: ["professional certifications profile", "certification profile", "career profile", "professional identity"],
  alternates: { canonical: "https://xrovia.com/certification-profile" },
  openGraph: { title: "Professional Certification Profile", description: "Professional Certification Profile | XROVIA", url: "https://xrovia.com/certification-profile", type: "website" },
};
...
export default function Page() {
  return (
    <main className="mx-auto max-w-4xl px-6 py-16">
      ...
      <h1 className="text-4xl font-bold tracking-tight">Professional Certification Profile</h1>
      <p className="mt-5 text-lg leading-8 text-gray-600">Keep professional certifications and learning achievements organized alongside your education, skills, projects, and work experience.</p>

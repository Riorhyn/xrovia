...
export const metadata: Metadata = {
  title: "Professional Skills Profile",
  description: "Professional Skills Profile | XROVIA",
  keywords: ["professional skills profile", "skills profile", "technical skills", "digital professional profile"],
  alternates: { canonical: "https://xrovia.com/skills-profile" },
  openGraph: { title: "Professional Skills Profile", description: "Professional Skills Profile | XROVIA", url: "https://xrovia.com/skills-profile", type: "website" },
};
...
export default function Page() {
  return (
    <main className="mx-auto max-w-4xl px-6 py-16">
      ...
      <h1 className="text-4xl font-bold tracking-tight">Professional Skills Profile</h1>
      <p className="mt-5 text-lg leading-8 text-gray-600">Organize technical and professional skills in one digital profile and connect them with education, projects, experience, and certifications.</p>

...
export const metadata: Metadata = {
  title: "Entry-Level Professional Profile",
  description: "Entry-Level Professional Profile | XROVIA",
  keywords: ["entry level professional profile", "entry level jobs", "fresher profile", "job application profile"],
  alternates: { canonical: "https://xrovia.com/entry-level-profile" },
  openGraph: { title: "Entry-Level Professional Profile", description: "Entry-Level Professional Profile | XROVIA", url: "https://xrovia.com/entry-level-profile", type: "website" },
};
...
export default function Page() {
  return (
    <main className="mx-auto max-w-4xl px-6 py-16">
      ...
      <h1 className="text-4xl font-bold tracking-tight">Entry-Level Professional Profile</h1>
      <p className="mt-5 text-lg leading-8 text-gray-600">A practical professional profile for people applying to entry-level jobs, internships, trainee roles, and graduate opportunities.</p>

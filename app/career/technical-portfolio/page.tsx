...
export const metadata: Metadata = {
  title: "Technical Portfolio for Engineers",
  description: "Technical Portfolio for Engineers | XROVIA",
  keywords: ["technical portfolio", "engineering portfolio", "project portfolio", "professional profile"],
  alternates: { canonical: "https://xrovia.com/technical-portfolio" },
  openGraph: { title: "Technical Portfolio for Engineers", description: "Technical Portfolio for Engineers | XROVIA", url: "https://xrovia.com/technical-portfolio", type: "website" },
};
...
export default function Page() {
  return (
    <main className="mx-auto max-w-4xl px-6 py-16">
      ...
      <h1 className="text-4xl font-bold tracking-tight">Technical Portfolio for Engineers</h1>
      <p className="mt-5 text-lg leading-8 text-gray-600">Organize engineering projects, technical skills, education, certifications, and experience into a shareable professional record.</p>
